...
export { PlayerRoute } from "./HandlebarsRoutes"
...
export function PlayerPlaceholderLoader() {
    return {
        vitals: {
...
export async function PlayerLoader({ username }, { onError }) {
